# 🏆 Champion Model: V32 Time-Decay Blend (665k MAE)
...
To ensure 100% reproducibility of the 665,903 MAE submission, all dependent scripts have been snapshotted into the `src/` directory.

### Quick Start
You can run the full pipeline automatically from the root directory:
```powershell
python Results/Champions/V32_TimeDecay_665k/pipeline.py
```

### Manual Steps
If you prefer running step-by-step from the project root:
1. `python Results/Champions/V32_TimeDecay_665k/src/model_v18_dl_stack.py`
2. `python Results/Champions/V32_TimeDecay_665k/src/model_v25_components.py`
3. `python Results/Champions/V32_TimeDecay_665k/src/blend_v25_sweep.py`
4. `python Results/Champions/V32_TimeDecay_665k/src/model_v28_oneshot_components.py`
5. `python Results/Champions/V32_TimeDecay_665k/src/blend_time_decay.py`

The final output will be generated at:
`Results/submissions/final_sweeps/submission_time_decay_10_50.csv`
